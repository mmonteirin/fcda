  ...
  return (
    <>
      <button
        ...
        className="flex items-center gap-2 rounded-full border border-border/80 bg-background/60 hover:bg-secondary px-3.5 py-1.5 text-xs text-muted-foreground transition-colors shadow-xs backdrop-blur-xs"
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandList className="max-h-[380px] overflow-y-auto">
          ...
          <CommandGroup heading="Páginas e Serviços">
            <CommandItem onSelect={() => handleSelect("/eventos")} className="gap-2 cursor-pointer">
            ...
            <CommandItem onSelect={() => handleSelect("/clubes")} className="gap-2 cursor-pointer">
            ...
            <CommandItem onSelect={() => handleSelect("/recordes")} className="gap-2 cursor-pointer">
              <Flame className="h-4 w-4 text-orange-500" />
              <span>Recordes Cearenses</span>
            </CommandItem>
            <CommandItem onSelect={() => handleSelect("/cursos")} className="gap-2 cursor-pointer">
              <GraduationCap className="h-4 w-4 text-primary" />
              <span>Cursos & Capacitação</span>
            </CommandItem>
            <CommandItem onSelect={() => handleSelect("/filie-se")} className="gap-2 cursor-pointer">
              <UserPlus className="h-4 w-4 text-primary" />
              <span>Filie-se / Vinculação</span>
            </CommandItem>
            <CommandItem onSelect={() => handleSelect("/contato")} className="gap-2 cursor-pointer">
